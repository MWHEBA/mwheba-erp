...
python customer/tests/run_customer_tests.py test
```

### إنشاء بيانات اختبار
```bash
python customer/tests/run_customer_tests.py create-data
```

### عرض الإحصائيات
```bash
python customer/tests/run_customer_tests.py stats
```

### مسح بيانات الاختبار
```bash
python customer/tests/run_customer_tests.py clean
```
