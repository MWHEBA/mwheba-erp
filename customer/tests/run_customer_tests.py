...
def run_customer_tests():
    ...
    test_labels = [
        "customer.tests.test_models",
        "customer.tests.test_forms",
        "customer.tests.test_signals",
        "customer.tests.test_views",
        "customer.tests.test_apis"
    ]
...
def show_test_statistics():
    ...
    try:
        ...
        government_count = Customer.objects.filter(customer_type="government").count()
...
def main():
    ...
    if len(sys.argv) < 2:
        print("الاستخدام:")
        print("  python run_customer_tests.py test           - تشغيل الاختبارات")
        print("  python run_customer_tests.py create-data    - إنشاء بيانات اختبار")
        print("  python run_customer_tests.py stats          - عرض الإحصائيات")
        print("  python run_customer_tests.py clean          - مسح بيانات الاختبار")
        return
