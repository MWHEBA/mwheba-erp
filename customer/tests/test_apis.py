...
class CustomerCreateAccountAPITest(TestCase):
    ...
    def test_get_create_account_modal_html(self):
        ...
        response = self.client.get(
            reverse("customer:customer_create_account", kwargs={'pk': self.customer.pk}),
    ...
    def test_create_account_ajax_error_handling(self):
        ...
        response = self.client.post(
            reverse("customer:customer_create_account", kwargs={'pk': 99999}),
            HTTP_X_REQUESTED_WITH='XMLHttpRequest'
        )
...
class CustomerChangeAccountAPITest(TestCase):
    ...
    def test_change_account_view_loads(self):
        ...
        response = self.client.get(
            reverse("customer:customer_change_account", kwargs={'pk': self.customer.pk})
        )
    ...
    def test_change_account_with_invalid_customer(self):
        ...
        response = self.client.get(
            reverse("customer:customer_change_account", kwargs={'pk': 99999})
        )
...
class CustomerIntegrationAPITest(TestCase):
    ...
    def test_full_customer_lifecycle(self):
        ...
        # 2. عرض التفاصيل
        response = self.client.get(
            reverse("customer:customer_detail", kwargs={'pk': customer_pk})
        )
        self.assertEqual(response.status_code, 200)
        
        # 3. تعديل العميل
        response = self.client.get(
            reverse("customer:customer_edit", kwargs={'pk': customer_pk})
        )
        self.assertEqual(response.status_code, 200)
