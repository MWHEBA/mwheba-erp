        ...
        with transaction.atomic():
            ...
            if locked_customer.financial_account:
                ...
                gateway.create_journal_entry(
                    ...
                    lines=lines,
                    idempotency_key=f"JE:customer:CustomerAllocationAudit:{last_audit.id if last_audit else sale.id}:reclassify",
            ...
            try:
                ...
                if advance_acc:
                    ...
                    gateway.create_journal_entry(
                        ...
                        lines=lines,
                        idempotency_key=f"JE:customer:CustomerPayment:{payment.id}",
                        user=user,
                        entry_type="automatic",
