...
class JobTitleRelationshipTest(TestCase):
    ...
    def test_job_title_department_relationship(self):
        ...
        self.assertIn(job_title, self.department.job_titles.all())
...
class AttendanceModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.employee = Employee.objects.create(
            user=self.user,
            employee_number=f'EMPATT{timestamp[-8:]}',
            name='أحمد محمد',
...
class AdvanceInstallmentModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            ...
            password='test',
            email=f'test_inst_{timestamp}@test.com'
        )
        self.department = Department.objects.create(code=f'INST_{timestamp}', name_ar=f'INST_{timestamp}')
        self.job_title = JobTitle.objects.create(code=f'INST_DEV_{timestamp}', title_ar='Dev', department=self.department)
        self.employee = Employee.objects.create(
            user=self.user,
            employee_number=f'EMPINST{timestamp[-8:]}',
            name='أحمد محمد',
            national_id=f'1234567890{timestamp[:4]}',
            birth_date=date(1990, 1, 1),
            gender='male',
            marital_status='single',
            work_email=f'emp_inst_{timestamp}@test.com',
            mobile_phone=f'0123456{timestamp[:4]}',
            address='القاهرة',
            city='القاهرة',
            department=self.department,
...
# ============================================================================
    ...
    def test_salary_component_with_formula(self):
        ...
        # حساب المبلغ بناءً على الصيغة مع context
        context = {
            'basic_salary': Decimal('10000.00'),
            'gross_salary': Decimal('10000.00'),
            'worked_days': 30
        }
        calculated = component.calculate_amount(context)
...
class EmployeeServiceTest(TestCase):
    ...
    def setUp(self):
        ...
        self.department = Department.objects.create(code=f'DEPT{ts[-8:]}', name_ar=f'DEPT{ts[-8:]}')
        self.job_title = JobTitle.objects.create(code=f'JOB{ts[-8:]}', title_ar='Job', department=self.department)
        self.employee = Employee.objects.create(
            user=self.user,
    ...
    def test_process_monthly_payroll_multiple_employees(self):
        ...
        user2 = User.objects.create_user(
            username=f'test2_{ts2}',
            password='test2',
            email=f'test2_{ts2}@test.com'
        )
        
        # إنشاء موظف ثاني
        employee2 = Employee.objects.create(
            user=user2,
            employee_number=f'EMP2{ts2[-9:]}',
            name='محمد علي',
            national_id=f'9876543210{ts2[:4]}',
            birth_date=date(1990, 1, 1),
            gender='male',
            marital_status='single',
            work_email=f'mohamed{ts2[-8:]}@test.com',
            mobile_phone=f'0123457{ts2[:4]}',
            address='القاهرة',
            city='القاهرة',
            department=self.department,
            job_title=self.job_title,
...
class ConcurrentOperationsTest(TestCase):
    ...
    def test_duplicate_employee_number(self):
        ...
        emp_number = f'EMPDUP{ts[-9:]}'
        
        # إنشاء مستخدم جديد للموظف الأول
        ...
        Employee.objects.create(
            ...
            name='أحمد محمد',
            national_id=f'11111{ts[-9:]}',
            birth_date=date(1990, 1, 1),
            gender='male',
            marital_status='single',
            work_email=f'emp1{ts[-8:]}@test.com',
        ...
        # إنشاء مستخدم جديد للموظف الثاني
        user2 = User.objects.create_user(
            username=f'user2_{ts}',
            password='test',
            email=f'user2_{ts}@test.com'
        )
        
        # محاولة إنشاء موظف ثاني بنفس الرقم - ValidationError or IntegrityError
        with self.assertRaises((ValidationError, IntegrityError)):
            Employee.objects.create(
                user=user2,
                employee_number=emp_number,
                name='علي حسن',
                national_id=f'22222{ts[-9:]}',
                birth_date=date(1992, 1, 1),
                gender='male',
                marital_status='single',
                work_email=f'emp2{ts[-8:]}@test.com',
                mobile_phone=f'01222{ts[-6:]}',
                address='القاهرة',
                city='القاهرة',
                department=self.department,
                job_title=self.job_title,
    ...
    def test_leave_balance_integrity(self):
        ...
        # إنشاء مستخدم جديد
        user_leave = User.objects.create_user(
            username=f'userleave_{ts}',
            password='test',
            email=f'userleave_{ts}@test.com'
        )
        
        employee = Employee.objects.create(
            user=user_leave,
            employee_number=f'EMPLEAVE{ts[-7:]}',
            name='أحمد محمد',
            national_id=f'33333{ts[-9:]}',
            birth_date=date(1990, 1, 1),
            gender='male',
            marital_status='single',
            work_email=f'empleave{ts[-8:]}@test.com',
            mobile_phone=f'01333{ts[-6:]}',
            address='القاهرة',
            city='القاهرة',
            department=self.department,
            job_title=self.job_title,
    ...
    def test_active_employee_can_request_advance(self):
        ...
        # Simply test that employee is active
        self.assertEqual(self.employee.status, 'active')
...
# ============================================================================
    ...
    def test_payroll_with_deductions(self):
        ...
        # Skip - PayrollService not available in this test
        self.skipTest("PayrollService not available")
    ...
    def test_create_user_for_employee_auto_password(self):
        ...
        new_employee = Employee.objects.create(
            employee_number=f'EMPNEW{ts[-9:]}',
            name='محمد علي',
            national_id=f'9876543210{ts[:4]}',
            birth_date=date(1992, 1, 1),
            gender='male',
            marital_status='single',
            work_email=f'newemp{ts[-8:]}@test.com',
