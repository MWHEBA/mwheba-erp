...
class UserEmployeeService:
    ...
    def sync_user_data_to_employee(user):
        ...
        # تحديث البيانات
        if user.first_name and user.last_name and not employee.name:
    ...
    def sync_employee_data_to_user(employee):
        ...
        # تحديث البيانات
        name_parts = employee.name.split(maxsplit=1) if employee.name else ['', '']
