    ...
    if load_test_data:
        ...
        try:
            ...
            paper_types_data = [
                {
                    "name": "كوشيه",
                    "description": "ورق كوشيه عالي الجودة للطباعة الملونة",
                },
        ...
        if run_command(
            "python manage.py loaddata pricing/fixtures/sample_orders.json", check=False
        ):
        ...
        if run_command(
            "python manage.py loaddata pricing/fixtures/sample_quotations.json",
            check=False,
        ):
