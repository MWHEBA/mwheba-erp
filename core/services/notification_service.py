...
class NotificationService:
    ...
    def check_low_stock_alerts():
        ...
        try:
            ...
            low_stock_products = [product for product in products if product.current_stock <= product.min_stock]
    ...
    def check_all_alerts():
        ...
        try:
            ...
            logger.info(f"تم فحص جميع التنبيهات - إجمالي {len(all_notifications)} تنبيه جديد")
