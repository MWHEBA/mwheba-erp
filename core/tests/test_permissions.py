...
class PermissionTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.manager_user = User.objects.create_user(
            username="manager", email="manager@example.com", password="managerpass123"
        )

        self.finance_user = User.objects.create_user(
            username="finance", email="finance@example.com", password="financepass123"
        )
        ...
        view_product = Permission.objects.get(
            content_type=product_type, codename="view_product"
        )
        add_product = Permission.objects.get(
            content_type=product_type, codename="add_product"
        )
        change_product = Permission.objects.get(
            content_type=product_type, codename="change_product"
        )
        delete_product = Permission.objects.get(
            content_type=product_type, codename="delete_product"
        )
        ...
        change_sale = Permission.objects.get(
            content_type=sale_type, codename="change_sale"
        )

        # أذونات المعاملات المالية
        view_transaction = Permission.objects.get(
            content_type=transaction_type, codename="view_transaction"
        )
        add_transaction = Permission.objects.get(
            content_type=transaction_type, codename="add_transaction"
        )
        ...
        self.finance_group.permissions.add(view_sale, view_transaction, add_transaction)
        ...
        self.category = Category.objects.create(
            name="فئة اختبار", created_by=self.admin_user
        )
