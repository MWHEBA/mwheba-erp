...
class UtilsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="utilsuser", email="utils@example.com", password="utils123"
        )
...
class FormatFunctionsTest(TestCase):
    ...
    def test_format_currency(self):
        ...
        self.assertEqual(
            format_currency(1000.567, "EGP", decimal_places=3), "1,000.567 ج.م"
        )
    ...
    def test_format_number(self):
        ...
        self.assertEqual(
            format_number(1000.5, decimal_places=0), "1,001"
        )  # تقريب لأقرب رقم صحيح
        self.assertEqual(format_number(1000.5, decimal_places=2), "1,000.50")
        self.assertEqual(
            format_number(1000.567, decimal_places=2), "1,000.57"
        ...
        self.assertEqual(
            format_number(1000.5, thousand_separator=" ", decimal_separator=","),
            "1 000,5",
        )
...
class CalculationFunctionsTest(TestCase):
    ...
    def test_calculate_total(self):
        ...
        # اختبار حساب المجموع مع ضريبة
        self.assertEqual(
            calculate_total(items, tax_rate=10), 467.5
        )  # 425 + (425 * 0.1) = 467.5

        # اختبار حساب المجموع مع خصم وضريبة
        self.assertEqual(
            calculate_total(items, discount=25, tax_rate=10), 440
        )  # (425 - 25) + ((425 - 25) * 0.1) = 440
...
class UtilsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.permission1 = Permission.objects.create(
            codename="can_test", name="Can Test", content_type=self.content_type
        )
