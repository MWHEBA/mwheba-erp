...
class Purchase(models.Model):
    ...
    status = models.CharField(_('الحالة'), max_length=20, choices=STATUS_CHOICES, default='confirmed')
    ...
    def save(self, *args, **kwargs):
        ...
        # إنشاء قيد محاسبي تلقائياً (فقط للفواتير الجديدة المؤكدة وبدون قيد)
    ...
    def amount_paid(self):
        ...
        """
        return self.payments.filter(status='posted').aggregate(models.Sum('amount'))['amount__sum'] or 0
