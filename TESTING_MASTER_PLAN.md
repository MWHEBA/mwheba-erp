...
3. **إذون استلام البضائع والمطابقة الثلاثية (GRN & 3-Way Matching):**
   - تسجيل إثبات الاستلام الفعلي في المخزن (`Goods Receipt Note - GRN`) قبل وصول الفاتورة.
...
> **النطاق:** دليل الحسابات ومراكز التكلفة + الخزن والبنوك + التحويلات النقدية والعملات + المصروفات والإيرادات العامة + إقرار الإيرادات المؤجلة + إعادة تقييم العملات + إقفال الفترات المالية + التقارير الختامية.
...
5. **إعادة تقييم العملات الأجنبية (FX Revaluation Engine):**
