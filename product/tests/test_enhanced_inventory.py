...
from product.models import (
    ...
    StockReservation, ReservationFulfillment,
    ProductBatch, ExpiryAlert,
    LocationZone, LocationAisle, LocationShelf, ProductLocation
)
...
class BaseInventoryTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.brand = Brand.objects.create(
            name='سامسونج',
            description='علامة تجارية كورية'
        )
