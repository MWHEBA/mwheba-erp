...
from product.models import (
    ...
    StockReservation, ProductBatch, ExpiryAlert,
...
class SupplierPricingAPITestCase(TestCase):
    ...
    def test_edit_supplier_price_api(self):
        ...
        url = reverse('product:edit_supplier_price_api', kwargs={'pk': supplier_price.pk})
    ...
    def test_set_default_supplier_api(self):
        ...
        url = reverse('product:set_default_supplier_api', kwargs={'pk': supplier_price2.pk})
    ...
    def test_supplier_price_history_api(self):
        ...
        url = reverse('product:supplier_price_history_api', kwargs={'pk': supplier_price.pk})
    ...
    def test_product_price_comparison_api(self):
        ...
        url = reverse('product:product_price_comparison_api', kwargs={'product_id': self.product.id})
