...
urlpatterns = [
    ...
    path('images/<int:pk>/delete/', views.delete_product_image, name='delete_product_image_alt'),
    ...
    # APIs أسعار الموردين
    path('api/supplier-prices/add/', views.add_supplier_price_api, name='add_supplier_price_api'),
    path('api/supplier-prices/<int:pk>/edit/', views.edit_supplier_price_api, name='edit_supplier_price_api'),
    path('api/supplier-prices/<int:pk>/set-default/', views.set_default_supplier_api, name='set_default_supplier_api'),
    path('api/supplier-prices/<int:pk>/history/', views.supplier_price_history_api, name='supplier_price_history_api'),
    path('api/products/<int:product_id>/price-comparison/', views.product_price_comparison_api, name='product_price_comparison_api'),
    
    # التقارير المتقدمة
    path('reports/abc-analysis/', inventory_views.abc_analysis_report, name='abc_analysis_report'),
    path('reports/inventory-turnover/', inventory_views.inventory_turnover_report, name='inventory_turnover_report'),
    path('reports/stock-aging/', inventory_views.stock_aging_report, name='stock_aging_report'),
    path('reports/reorder-point/', inventory_views.reorder_point_report, name='reorder_point_report'),
