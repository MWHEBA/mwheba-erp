...
class ProductStock(models.Model):
    ...
    last_purchase_date = models.DateTimeField(
        _("تاريخ آخر شراء"), null=True, blank=True
    )

    last_sale_date = models.DateTimeField(_("تاريخ آخر بيع"), null=True, blank=True)
...
class StockTransfer(models.Model):
    ...
    status = models.CharField(
        _("الحالة"), max_length=20, choices=TRANSFER_STATUS_CHOICES, default="draft"
    )
