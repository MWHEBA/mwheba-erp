...
class ProductSearchForm(forms.Form):
    ...
    category = forms.ModelChoiceField(queryset=Category.objects.all(), required=False, label=_('التصنيف'))
    brand = forms.ModelChoiceField(queryset=Brand.objects.all(), required=False, label=_('النوع'))
