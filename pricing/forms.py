...
class PricingOrderForm(forms.ModelForm):
    ...
    paper_supplier = forms.ModelChoiceField(
        ...
        queryset=Supplier.objects.filter(
            is_active=True,
            id__in=PaperServiceDetails.objects.filter(service__is_active=True)
        ...
        try:
            ...
            if sides_count == 2:  # الطباعة على وجهين
                if colors_front is None:
                    self.add_error(
                        "colors_front", _("يجب تحديد عدد ألوان الوجه الأمامي")
                    )
    ...
    class Meta:
        ...
        widgets = {
            "comment": forms.Textarea(
                attrs={"rows": 2, "placeholder": _("أضف تعليقك هنا...")}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: ورق عادي"}
            ),
            "gsm": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "مثال: 80",
                    "min": "50",
...
class PaperTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: ورق مطبوع"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class PaperSizeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: A4"}
            ),
        ...
        if is_default:
            ...
            if existing_default.exists():
                raise forms.ValidationError(
                    _("يمكن أن يكون هناك مقاس افتراضي واحد فقط")
                )
...
class PaperOriginForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: مصر"}
            ),
    ...
    def clean(self):
        ...
        if is_default:
            ...
            if existing_default.exists():
                raise forms.ValidationError(
                    _("يمكن أن يكون هناك منشأ افتراضي واحد فقط")
                )
...
class OffsetMachineTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "code": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: OFF-HALF"}
            ),
            "manufacturer": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: هايدلبرغ"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class CoatingTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: تغطية لامعة"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class DigitalMachineTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "code": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: DIG-A3"}
            ),
            "manufacturer": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: كانون"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class ProductTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: كتالوج"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
    ...
    def clean(self):
        ...
        if is_default:
            ...
            if existing_default.exists():
                raise forms.ValidationError(
                    _("يمكن أن يكون هناك نوع منتج افتراضي واحد فقط")
                )
...
class FinishingTypeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": _("اسم نوع التشطيب")}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class OffsetSheetSizeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: فرخ كامل"}
            ),
            "code": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: FULL-SHEET"}
            ),
...
class DigitalSheetSizeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: A3"}
            ),
            "code": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "مثال: A3-SIZE"}
            ),
            "width_cm": forms.NumberInput(
                attrs={
                    "class": "form-control",
