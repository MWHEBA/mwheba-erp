...
class PaperCalculatorService:
    ...
    @staticmethod
    def calculate_paper_cost(supplier_id, paper_type_id, paper_size_id, weight, quantity, origin='local'):
        """حساب تكلفة الورق"""
        try:
            # البحث عن خدمة الورق
    ...
    @staticmethod
    def calculate_sheets_needed(quantity, has_internal_content=False, internal_pages=0, waste_percentage=5):
    ...
    def get_paper_suppliers_by_type(paper_type_id, paper_size_id=None, weight=None):
        ...
        try:
            ...
            services = PaperServiceDetails.objects.filter(**filters).select_related('supplier')
