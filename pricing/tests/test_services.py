...
class PricingCalculatorTestCase(TestCase):
    ...
    def test_calculate_profit_margin(self):
        ...
        profit_amount = self.calculator.calculate_profit_margin(total_cost, profit_percentage)
    ...
    def test_calculate_selling_price(self):
        ...
        selling_price = self.calculator.calculate_selling_price(total_cost, profit_margin)
...
class PrintCalculatorTestCase(TestCase):
    ...
    def test_calculate_setup_cost(self):
        ...
        setup_cost = self.calculator.calculate_setup_cost(
            colors, setup_cost_per_color
        )
