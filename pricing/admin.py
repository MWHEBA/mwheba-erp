...
class PricingOrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("المحتوى"), {"fields": ("has_internal_content",)}),
        (
            _("معلومات الطباعة"),
            {
                "fields": (
        ...
        (_("المورد"), {"fields": ("supplier", "press")}),
        (
            _("التكاليف والأسعار"),
            {
                "fields": (
    ...
    inlines = [
        InternalContentInline,
        OrderFinishingInline,
        ExtraExpenseInline,
        OrderCommentInline,
    ]
...
class OffsetMachineTypeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("معلومات أساسية"), {"fields": ("name", "code", "manufacturer")}),
        (_("الوصف"), {"fields": ("description",)}),
...
class OffsetSheetSizeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("معلومات أساسية"), {"fields": ("name", "code")}),
        (_("الأبعاد"), {"fields": ("width_cm", "height_cm", "area_cm2", "area_m2")}),
        (_("الوصف"), {"fields": ("description",)}),
        (_("الإعدادات"), {"fields": ("is_active", "is_default", "is_custom_size")}),
        (
            _("معلومات النظام"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
