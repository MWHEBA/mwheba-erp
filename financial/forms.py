...
class AccountForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "bank_name": forms.TextInput(attrs={"class": "form-control", "placeholder": "مثال: البنك الأهلي المصري"}),
            "account_number": forms.TextInput(attrs={"class": "form-control", "placeholder": "رقم الحساب البنكي"}),
            "iban": forms.TextInput(attrs={"class": "form-control", "placeholder": "رقم الآيبان"}),
...
class TransactionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["date"].initial = get_system_today()
...
class BankReconciliationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        from utils.helpers import get_system_today
        self.fields["reconciliation_date"].initial = get_system_today()
