...
urlpatterns = [
    ...
    path("opening-balances/<int:pk>/balancing-options/", views.opening_balance_get_balancing_options, name="opening_balance_get_balancing_options"),
    path("opening-balances/<int:pk>/apply-balancing/", views.opening_balance_apply_balancing_action, name="opening_balance_apply_balancing_action"),
