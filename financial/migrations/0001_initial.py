        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account_number",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="رقم الحساب"
                    ),
                ),
                (
                    "type",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="يخضع للتسوية البنكية"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("expense", "مصروف"), ("income", "إيراد")],
                        max_length=20,
                        verbose_name="النوع",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="تاريخ المصروف"
                    ),
                ),
                (
                    "payment_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="تاريخ الإيراد"
                    ),
                ),
                (
                    "received_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "debit",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="مدين"
                    ),
                ),
                (
                    "credit",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="دائن"
                    ),
                ),
                (
                    "description",
