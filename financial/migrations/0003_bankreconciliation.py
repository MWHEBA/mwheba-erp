        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "system_balance",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="رصيد النظام"
                    ),
                ),
                (
                    "bank_balance",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="رصيد البنك"
                    ),
                ),
                (
                    "difference",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="الفرق"
                    ),
                ),
                (
                    "notes",
