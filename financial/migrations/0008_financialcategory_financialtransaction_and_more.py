...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to="financial/attachments/%Y/%m/", verbose_name="الملف"
                    ),
                ),
                (
                    "filename",
                ...
                (
                    "content_type",
                    models.CharField(max_length=100, verbose_name="نوع المحتوى"),
                ),
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="الوصف"
                    ),
                ),
                (
                    "uploaded_at",
        ...
        migrations.AddIndex(
            model_name="financialtransaction",
            index=models.Index(
                fields=["status", "created_at"], name="financial_f_status_299db0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="financialtransaction",
            index=models.Index(
                fields=["account", "date"], name="financial_f_account_8de9e4_idx"
            ),
        ),
