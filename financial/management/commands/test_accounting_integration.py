...
from financial.models import ChartOfAccounts, JournalEntry, JournalEntryLine, AccountingPeriod
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--create-test-data',
            action='store_true',
            help='إنشاء بيانات اختبار وهمية'
        )
        parser.add_argument(
    ...
    def handle(self, *args, **options):
        self.stdout.write(
            self.style.SUCCESS('🧪 بدء اختبار التكامل المحاسبي الشامل...')
        )
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(f'❌ خطأ في الاختبار: {str(e)}')
            )
    ...
    def test_basic_system(self):
        ...
        required_accounts = ['1001', '1002', '1201', '1301', '2101', '4001', '5001', '5002']
        missing_accounts = []
    ...
    def test_accounting_integration_service(self):
        ...
        purchase_accounts = AccountingIntegrationService._get_required_accounts_for_purchase()
        ...
        payment_accounts = AccountingIntegrationService._get_required_accounts_for_payment()
    ...
    def generate_test_report(self):
        ...
        report = {
            ...
            'posted_entries_count': JournalEntry.objects.filter(status='posted').count(),
