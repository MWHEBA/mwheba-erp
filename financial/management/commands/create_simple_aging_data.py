"""
أمر بسيط لإنشاء قيود محاسبية لاختبار تقارير أعمار الذمم
"""
...
class Command(BaseCommand):
    help = 'إنشاء قيود محاسبية بسيطة لاختبار تقارير أعمار الذمم'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('🚀 بدء إنشاء قيود أعمار الذمم...'))
