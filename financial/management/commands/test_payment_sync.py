...
class Command(BaseCommand):
    ...
    def check_system(self):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"خطأ في استيراد النماذج: {e}"))
    ...
    def test_sync(self):
        ...
        try:
            ...
            self.stdout.write(
                f'العمليات المكتملة: {stats.get("completed_operations", 0)}'
            )
    ...
    def enable_sync(self):
        ...
        try:
            ...
            rules_updated = PaymentSyncRule.objects.filter(is_active=False).update(
                is_active=True
            )
            self.stdout.write(
    ...
    def disable_sync(self):
        ...
        try:
            ...
            rules_updated = PaymentSyncRule.objects.filter(is_active=True).update(
                is_active=False
            )
            self.stdout.write(
