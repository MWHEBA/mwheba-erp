            ...
            payment_data.update(
                {
                    ...
                    "parent_id": payment_obj.sale.parent.id,
                    "parent_name": payment_obj.sale.parent.name,
                }
            )
    ...
    def _sync_to_journal_entry(
        ...
        try:
            if sync_operation.operation_type == "create_payment":
                ...
                if hasattr(payment_obj, "sale"):
                    # دفعة مبيعات - استخدام التصنيف المالي من الفاتورة
                    financial_category = None
                    if hasattr(payment_obj.sale, 'financial_category'):
                    ...
                    # دفعة مشتريات - استخدام التصنيف المالي من الفاتورة
                    financial_category = None
                    if hasattr(payment_obj.purchase, 'financial_category'):
