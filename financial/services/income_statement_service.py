...
تطبيق كامل للمعايير المحاسبية المعتمدة بهيكل متعدد المراحل (Multi-Step)،
...
class IncomeStatementService:
    ...
    def generate_income_statement(
        ...
        """
        إنشاء قائمة الدخل المعيارية متعددة المراحل
        """
        try:
    ...
    def export_to_excel(
        ...
        try:
            ...
            # الترويسة الرئيسية
            ws['A1'] = "تقرير قائمة الدخل والأرباح والخسائر"
