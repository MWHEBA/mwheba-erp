...
class AccountRoleRegistry:
    ...
    ROLE_MAP: Dict[str, str] = {
        ...
        "SALES_DISCOUNTS_ACCOUNT": getattr(settings, "DEFAULT_SALES_DISCOUNTS_ACCOUNT_CODE", "41930"),
        "PURCHASE_RETURNS_ACCOUNT": getattr(settings, "DEFAULT_PURCHASE_RETURNS_ACCOUNT_CODE", "51910"),
        "PURCHASE_DISCOUNTS_ACCOUNT": getattr(settings, "DEFAULT_PURCHASE_DISCOUNTS_ACCOUNT_CODE", "51930"),
        "EARNED_DISCOUNT_ACCOUNT": getattr(settings, "DEFAULT_PURCHASE_DISCOUNTS_ACCOUNT_CODE", "51930"),
