...
class PaymentEditService:
    ...
    @classmethod
    def unpost_payment(
        cls, payment, payment_type: str, user: User, reason: str = ""
    ) -> Dict[str, Any]:
        """
    ...
    def _get_payment_data(cls, payment) -> Dict[str, Any]:
        ...
        return {
            ...
            "financial_account_id": payment.financial_account.id
            if payment.financial_account
            else None,
            "financial_account_name": payment.financial_account.name
            if payment.financial_account
            else None,
