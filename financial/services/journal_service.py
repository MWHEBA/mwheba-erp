...
class JournalEntryService:
        ...
        lines_data = [
            {
                ...
                if isinstance(debit_account, ChartOfAccounts)
                else (debit_account if isinstance(debit_account, int) else None),
                "debit": amount,
                "credit": 0,
                "description": description,
            },
            {
                ...
                if isinstance(credit_account, ChartOfAccounts)
                else (credit_account if isinstance(credit_account, int) else None),
                "debit": 0,
                "credit": amount,
                "description": description,
            },
    ...
    @staticmethod
    def reverse_entry(
        entry_id: int, user=None, description: str = None
    ) -> JournalEntry:
        """
        عكس قيد محاسبي
        """
...
class AutoJournalService:
    ...
    def create_payment_entry(
        payment_obj, payment_type="customer", user=None
    ) -> JournalEntry:
        """
