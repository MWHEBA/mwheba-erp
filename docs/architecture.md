...
### 2.11 financial
**الغرض:** المحاسبة المزدوجة المركزية ومحرك حوكمة العملات الدولية.

#### أ) شجرة الحسابات والقيود اليومية
* **5 مستويات هرمية** للأصول، الالتزامات، حقوق الملكية، الإيرادات، والمصروفات.
* قيود يومية مزدوجة متزنة صارمة ($\sum Debit = \sum Credit$).

#### ب) محرك تقييم العملات المتعددة الدولية (`financial/fx/`)
...
/financial/             → موديول المالية والحسابات ومحرك العملات المتعددة
