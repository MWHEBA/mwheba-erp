...
class SalePayment(PaymentAuditMixin, models.Model):
    ...
    sale = models.ForeignKey('sale.Sale', on_delete=models.CASCADE, verbose_name=_('الفاتورة'), related_name='payments')
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT,
                                 verbose_name=_('أنشئ بواسطة'), related_name='sale_payments_created')
